...
We will use a virtual machine for this textbook (Oracle VM Virtual Box):
...
*These steps have been adapted from [The Odin Project](https://www.theodinproject.com/lessons/foundations-installations)
